	...
	<body style="background: #e1e9eb;">
		<form action="<%=basePath %>List.action" id="mainForm" method="post">
			<div class="right">
				...
				<div class="rightCont">
					<p class="g_title fix">内容列表 <a class="btn03" href="<%=basePath%>insert">新 增</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn03" href="javascript:deleteBatch('<%=basePath%>');">删 除</a></p>
					<table class="tab1">
						<tbody>
							<tr>
						...
						<table class="tab2" width="100%">
							...
							<c:forEach items="${messageList }" var="message" 
								...
								style="background-color:#ECF6EE;"</c:if>>
									...
									<td>
										<a href="<%=basePath%>update?command=${message.command}">修改</a>&nbsp;&nbsp;&nbsp;
